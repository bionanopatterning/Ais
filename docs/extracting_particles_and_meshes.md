...
The text below describes how to use the Ais GUI for picking. Instructions for using the CLI tool instead can be found on the [command line interface](command_line_interface.md) page.
...
The second option is available in the same menu as particle picking: right-click any open feature in the Renderer and open the mesh extraction menu under 'Extract mesh'. Figure 15 shows the relevant parts of the GUI.

<figure markdown="span">
  ![GUI for mesh extraction](res/extracting_mesh.png){ .with-border }
  <figcaption>Figure 15 - GUI for mesh extraction.</figcaption>
</figure>
